...
public class GreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Boolean b = true;
                mListener.onFragmentInteraction(message, b);
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message = "Hello, Blue! I'm Green 2.";
                mListener.onFragmentInteraction(message,b);
            }
        });
    ...
    public void onButtonPressed(String uri, Boolean b) {
        if (mListener != null) {
            mListener.onFragmentInteraction(uri, b);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(String text,Boolean b);
    }
}
